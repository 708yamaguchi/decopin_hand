...
def main():
    archs = {  # only VGG16 is available now
        'vgg16': VGG16,
        # 'alex': alex.Alex,
    ...
    # device = chainer.cuda.get_device_from_id(args.device)  # for python2
    device = chainer.cuda.get_device_from_id(0)  # for python2
    # device = chainer.backends.cuda.get_device_from_id(args.device)  # for python2
    ...
    # TODO: change path of pretrained model
    # TODO: fix code style
    ...
    val = PreprocessedDataset(args.val, args.root, mean, False)
